...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    login: function login(state, userInfor) {
      state.isLogin = true;
    ...
    // 退出登录清除登录信息
    loginOut: function loginOut(state, userInfor) {
      state.isLogin = false;
      state.userInfor = {};
      uni.removeStorage({
        key: "userInfor" });
    ...
    // 改变tabbar样式
    changeTabBar: function changeTabBar(state, color) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var apiKesy = {
  listKey: "dc395d5a63f93dd6b34a1148eaab521d", // 视频列表接口key
  detailKey: "5a375a81699f486ca62db763f201656e" //视频详情接口key
};var _default =


apiKesy;exports.default = _default;
